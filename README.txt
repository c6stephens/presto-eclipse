...
2.  Get the 'presto' shell command working.
    ...
    a.  To access Presto from your desktop, you need to set up an SSH tunnel
        through an AWS server.

        Check to see if you can SSH to 'query-gateway.dataeng.netflix.net'
        ...
        On 'query-gateway', paste this public key to the end of:

            vi ~/.ssh/authorized_keys

        Now try to SSH to 'query-gateway.dataeng.netflix.net' without entering
        a password.
...
3.  Copy the Presto Plugin for Eclipse DTP jars into your install folder of
    Teradata Studio Express:
        ...
        sudo cp -v export/plugins/*.jar /Applications/TeradataStudioExpress/plugins

4.  Change the '-vm' setting from 'java' to 'libjvm.dylib' (of an installation
    of Java 7 or higher):
...
5.  Run Teradata Studio Express from the command line with the '-clean' option:
